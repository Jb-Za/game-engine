...
export class Quad2D {
    ...
    constructor(device: GPUDevice, camera: Camera, ambientLight: AmbientLight, pointLights: PointLightsCollection) {
        this.transformBuffer = new UniformBuffer(device, this.transform, "Quad2D Transform");
        this.normalMatrixBuffer = new UniformBuffer(device, 16 * Float32Array.BYTES_PER_ELEMENT, "Quad2D Normal Matrix");
