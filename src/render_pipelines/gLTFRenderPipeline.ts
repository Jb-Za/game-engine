...
import shaderSource from "../shaders/gLTFmaterialShader.wgsl?raw";
import { Texture2D } from "../texture/Texture2D";
import { UniformBuffer } from "../uniform_buffers/UniformBuffer";

export class gLTFRenderPipeline {
  ...
  public draw(renderPassEncoder: GPURenderPassEncoder, buffers: GeometryBuffers, jointIndicesBuffer: GPUBuffer, jointWeightsBuffer: GPUBuffer, instanceCount: number = 1) {
