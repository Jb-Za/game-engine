export class GTLFUtils {
  ...
  public static gltfVertexType(componentType: GLTFComponentType, type: GLTFType) {
    var typeStr = null;
    ...
    switch (GTLFUtils.gltfTypeNumComponents(type)) {
      case 1:
        return typeStr;
      case 2:
        return typeStr + "x2";
  ...
  public static gltfTypeSize(componentType: GLTFComponentType, type: GLTFType) {
    ...
    return GTLFUtils.gltfTypeNumComponents(type) * componentSize;
  }
}
