import { GLTFTextureFilter, GLTFTextureWrap, GLTFUtils } from "./GLTFUtils";
...
export class GLTFSampler {
  ...
  constructor(
    ...
    this.magFilter = GLTFUtils.gltfTextureFilterMode(magFilter);
    this.minFilter = GLTFUtils.gltfTextureFilterMode(minFilter);

    this.wrapU = GLTFUtils.gltfAddressMode(wrapU);
    this.wrapV = GLTFUtils.gltfAddressMode(wrapV);
  }
